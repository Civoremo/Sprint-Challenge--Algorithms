class SortingRobot:
    ...
    def sort(self):
        ...
        # if pickedUp item is less then currentPos item; move right
        # if pickedUp item is greater than currentPos item: swapItems
        # repeat process until you reach the end of list
        # bring item back to position with value None
        # go to next position and pick up item
        # move right comparing with those items
        # if pickedUp item is less than currentPos item; move right and compare again
        # if pickedUp item is greater than currentPos item: swap items
        # keep going comparing items until yo reach the end of list
